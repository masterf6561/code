...
import TestFile from "/Users/moritz/Documents/kamera/good_stuff/P1110789.jpeg";



const App = async () => {
  "use client";
  const image_path = "/Users/moritz/Documents/kamera/good_stuff/";
  const imageFilenames = await fs.readdir(image_path);
